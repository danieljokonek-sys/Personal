...
# ---------------------------------------------------------------------------
parser = argparse.ArgumentParser(description="Briefing Bot Setup Wizard")
parser.add_argument(
    "--app-dir",
...
class SetupWizard(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Briefing Bot — Setup Wizard")
    ...
    def _finish(self):
        try:
            ...
            messagebox.showinfo(
                "Setup Complete",
                "Your Briefing Bot is configured!\n\nThe wizard will now close.",
            )
            self.quit()
    ...
    def _build_page1(self):
        ...
        make_label(frame, "Welcome to Briefing Bot", size=18, bold=True, color=ACCENT).pack(pady=(20, 8))
    ...
    def _build_page8(self):
        ...
        make_label(
            frame,
            "Briefing Bot is configured and ready to go.",
            size=11,
            color=MUTED_FG,
        ).pack()
    ...
    def _write_config(self):
        ...
        yaml_lines = ["# Briefing Bot Configuration", "# Generated by setup_wizard.py", ""]
    ...
    def _setup_launchd(self):
        ...
        plist_path = os.path.join(launch_agents_dir, "com.briefingbot.daily.plist")
...
<dict>
    <key>Label</key>
    <string>com.briefingbot.daily</string>
